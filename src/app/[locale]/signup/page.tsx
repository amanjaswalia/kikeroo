        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <label className="flex items-start gap-2.5 cursor-pointer pt-1">
            <input
              ...
              className="rounded border-white/20 bg-transparent text-kik-gold focus:ring-kik-gold/30 mt-0.5"
            />
            <span className="text-white/40 text-xs leading-relaxed">
              {t('acceptTerms')}{' '}
              <Link
                href="/terms"
                className="text-kik-gold hover:text-kik-gold-light transition-colors"
              >
                {t('termsOfService')}
              </Link>{' '}
              {t('and')}{' '}
