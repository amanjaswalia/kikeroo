    ...
    >
      <div className="bg-kik-dark rounded-lg p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-2">Start your travel adventure today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-start gap-2 cursor-pointer">
            <input
              ...
              className="rounded border-gray-600 bg-transparent text-kik-gold focus:ring-kik-gold mt-1"
            />
            <span className="text-gray-400 text-sm">
              I agree to the{' '}
              <Link href="#" className="text-kik-gold hover:underline">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="#" className="text-kik-gold hover:underline">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-kik-dark text-gray-400">Or sign up with</span>
            </div>
          </div>
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          ...
          <Link href="/login" className="text-kik-gold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
